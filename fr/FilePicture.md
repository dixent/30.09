...
Par défaut, le Docker exposera le port 8080, changez donc cela dans le Dockerfile si nécessaire. Lorsque vous êtes prêt, utilisez simplement le Dockerfile pour créer l'image.
